...
public class QUrlTestUtils {
    ...
    public static List<QUrl> qUrls() {
        final QUrl qUrl1 = QUrl.builder().stamp("stamp1").url("url1").build();
        final QUrl qUrl2 = QUrl.builder().stamp("stamp2").url("url2").build();
        final QUrl qUrl3 = QUrl.builder().stamp("stamp3").url("url3").build();
    ...
    public static String expectedAddQUrlWithEmptyStamp() {
        return "";
    }
}
