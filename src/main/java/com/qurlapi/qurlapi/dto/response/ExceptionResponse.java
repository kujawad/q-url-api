...
public class ExceptionResponse {
    ...
    private String path;
    @ApiModelProperty(value = "Exception message.", name = "message", example = "Stamp does not exists!")
    private String message;
    @ApiModelProperty(value = "Timestamp of exception.", name = "timestamp", example = "1598990725")
